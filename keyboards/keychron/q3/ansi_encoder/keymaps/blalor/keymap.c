...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /*
        Esc       F1        F2        F3        F4        F5        F6        F7        F8        F9        F10       F11       F12         rot btn         Lndr      Astro     Moon
    ...
    */
    ...
    [_L1] = LAYOUT_tkl_f13_ansi(
        KC_ESC,   KC_BRID,  KC_BRIU,  XXXXXXX,  XXXXXXX,  RGB_VAD,  RGB_VAI,  KC_MPRV,  XXXXXXX,  KC_MNXT,  XXXXXXX,  XXXXXXX,  XXXXXXX,    RGB_TOG,        _______,  _______,  _______,
...
const ledmap PROGMEM ledmaps[] = {
    ...
    */
    [BASE] = RGB_MATRIX_LAYOUT_LEDMAP(
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,                     ______,   ORANGE,   TURQ,
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,     ______,         ______,   ______,   ______,
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,     ______,         ______,   ______,   ______,
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,               ______,
        ______,             ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,               ______,                   ______,
        ______,   ______,   ______,                                 ______,                                 ______,   ______,   TURQ,       ______,         ______,   ______,   ______
    ),

    [_L1]  = RGB_MATRIX_LAYOUT_LEDMAP(
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   MAGENT,   ______,   MAGENT,   ______,   ______,   ______,                     ______,   ______,   ______,
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,     ______,         ______,   ______,   ______,
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,     ______,         ______,   ______,   ______,
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,               ______,
        ______,             ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,               ______,                   ______,
    ...
    [_L2]  = RGB_MATRIX_LAYOUT_LEDMAP(
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,                     ______,   RED,      ______,
