...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_L1] = LAYOUT_tkl_ansi(
        KC_ESC,             KC_BRID,  KC_BRIU,  XXXXXXX,  XXXXXXX,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,    KC_VOLU,        _______,  _______,  _______,
...
const ledmap PROGMEM ledmaps[] = {
    ...
    */
    [BASE] = RGB_MATRIX_LAYOUT_LEDMAP(
        ______,             ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,           ______,   ORANG2,   LYRIND,
    ...
    [_L1]  = RGB_MATRIX_LAYOUT_LEDMAP(
        RED,                ______,   ______,   ______,   ______,   ______,   ______,   OFFBLU,   ______,   OFFBLU,   ______,   ______,   ______,       ______,   ______,   ______,
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,     ______,         ______,   ______,   ______,
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,     ______,         ______,   ______,   ______,
        ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,               ______,
        ______,             ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,   ______,               ______,                   ______,
    ...
    [_L2]  = RGB_MATRIX_LAYOUT_LEDMAP(
        GREEN,              ______,   ______,   ______,   ______,   ______,   ______,   ______,   PURPLE,   PURPLE,   ______,   ______,   ______,                     ______,   RED,      ______,
